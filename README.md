...
321 app Python files, 79,119 lines of app code, 117 Alembic migrations,
463 test files (clean-checkout counts), **2 GitHub stars, 0 forks** (measured 2026-08-21 via `gh
