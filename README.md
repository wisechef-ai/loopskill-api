...
310 app Python files, 75,354 lines of app code, 113 Alembic migrations,
432 test files (clean-checkout counts), **2 GitHub stars, 0 forks** (measured 2026-08-21 via `gh
