"""GitHub OAuth authentication for WiseRecipes creators.

Flow:
1. Creator clicks "Sign in with GitHub" -> redirects to GitHub OAuth
2. GitHub redirects back with code -> exchange for access token
3. Fetch GitHub user profile -> create/update User record
...
async def exchange_github_code(code: str) -> dict:
    """Exchange a GitHub OAuth code for an access token + user profile."""
