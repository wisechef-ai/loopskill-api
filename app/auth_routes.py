...
# ── First-key one-time reveal (flywheel F1.2) ───────────────────────────
...
async def first_key_reveal(
    ...
    mcp_endpoint = "https://app.loopskill.io/api/mcp/http"
    config_blocks = build_config_blocks(token=payload["key"], cookbook_id=None, server_url=mcp_endpoint)
