...
from app.connect_test_routes import router as connect_test_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(connect_test_router)  # t_a2ba8443: card "Test connection" + tested event
    ...
    from app.artifact_like_routes import router as artifact_like_router  # spotify_2607 PhB

    app.include_router(artifact_like_router, tags=["engagement"])
    ...
    app.include_router(fleet_member_router, tags=["fleet-members"])  # activate_0701 Phase 1
